...
# Note: the 83 channel graphcast-small model uses the following fields 
# channel = ['z50', 'z100', 'z150', 'z200', 'z250', 'z300', 'z400', 
# 'z500', 'z600', 'z700', 'z850', 'z925', 'z1000', 'q50', 'q100', 
# 'q150', 'q200', 'q250', 'q300', 'q400', 'q500', 'q600', 'q700', 
# 'q850', 'q925', 'q1000', 't50', 't100', 't150', 't200', 't250', 
# 't300', 't400', 't500', 't600', 't700', 't850', 't925', 't1000', 
# 'u50', 'u100', 'u150', 'u200', 'u250', 'u300', 'u400', 'u500', 
# 'u600', 'u700', 'u850', 'u925', 'u1000', 'v50', 'v100', 'v150', 
# 'v200', 'v250', 'v300', 'v400', 'v500', 'v600', 'v700', 'v850', 
# 'v925', 'v1000', 'w50', 'w100', 'w150', 'w200', 'w250', 'w300', 
# 'w400', 'w500', 'w600', 'w700', 'w850', 'w925', 'w1000', 'u10m', 
# 'v10m', 't2m', 'msl', 'tp06']

graphcast_levels = [50,100,150,200,250,300,400,500,600,700,850,925,1000]
graphcast_3dvars = ["Z", "Q", "T", "U", "V", "W"]
graphcast_2dvars = ["VAR_10U", "VAR_10V", "VAR_2T", "MSL", "TP06"]
nlat = 181
nlon = 360
...
def read_graphcast_vars_from_era5_rda(
    ...
    # coarsen the data to one degree resolution
    combined_xr = combined_xr.coarsen(latitude=4, longitude=4, boundary="pad").mean()
    
    # DEBUG: add TP06 variable on the end to see if it works
    combined_xr["TP06"] = combined_xr["VAR_10U"]*0
...
def rda_era5_to_graphcast_state(
    ...
    x : torch.Tensor
        a tensor with dimensions (1, 2, 83, 181, 360) containing the packed data
    
    """

    # read the data
    # unlike SFNO, graphcast expects latitude from -90 to 90
...
def set_graphcast_xarray_metadata(ds : xr.Dataset, copy : bool = False) -> xr.Dataset:
    ...
    # md['TCW']['units'] = 'kg/m^2'
    md['TP06']['long_name'] = 'total precipitation over the last 6 hours'
    md['TP06']['units'] = 'm'
